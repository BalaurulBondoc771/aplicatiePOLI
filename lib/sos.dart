              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _guideStep('1. Move to a safe area, away from traffic and unstable structures.'),
                    _guideStep('2. Quickly check if you or the people around you are seriously injured.'),
                    _guideStep('3. Save battery: reduce brightness and close unnecessary apps.'),
                    _guideStep('4. Enable location and Bluetooth for mesh coordination.'),
                    _guideStep('5. Send a short status update (SAFE / NEED HELP) to your family or group.'),
                    _guideStep('6. Keep water, a medical kit, and essential documents within reach.'),
                    _guideStep('7. Follow only verified information and your local evacuation plan.'),
                    const SizedBox(height: 8),
                  ],
                ),
              ),
